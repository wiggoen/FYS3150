...
fig = figure()
subplot(121)
hist(E_r[start:MCC-1]/N, bins=8, normed=1, facecolor='blue', alpha=0.75, label=r"$\sigma_E^2$ = %f" %Var_T1)
...
subplot(122)
hist(E_r[(MCC+start):]/N, bins=150, normed=1, facecolor='blue', alpha=0.75, label=r"$\sigma_E^2$ = %f" %Var_T24)  
xticks(rotation='vertical')
grid(True)
art = []
