...
L40_source = loadtxt("outputs/MPI_e_L40.txt")
...
def L40(L40_source):
    ...
    L40_norm2 = 1.0/(L40_N)
    L40_T = L40_source[:,2]
    L40_meanE = L40_source[:,3]*L40_norm1*L40_norm2/numprocs
    L40_meanE2 = L40_source[:,4]*L40_norm1*L40_norm2/numprocs                 # Mean energy
    L40_meanM = L40_source[:,5]*L40_norm1*L40_norm2/numprocs 
    L40_meanM2 = L40_source[:,6]*L40_norm1*L40_norm2/numprocs
    L40_mean_absM = L40_source[:,7]*L40_norm1*L40_norm2/numprocs              # Mean absolute magnetization
    L40_specificHeat = abs(L40_meanE2 - L40_meanE**2)/L40_T**2          # Heat capacity, Cv
    L40_Susceptibility = abs(L40_meanM2 - L40_mean_absM**2)/L40_T       # Susceptibility, Chi, X
